...
[![](./img/cheatsheet.png)](./img/cheatsheet.png)
...
The *graticule* type allows you to display the latitude and longitude lines around . [Source](https://github.com/neocarto/bertin/blob/main/src/layers/graticule.js).
