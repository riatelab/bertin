...
export function mushroom(
  ...
  for (let i = 0; i < features.length; i++) {
    ...
    let sel = selection
      ...
      .attr("data-layer", JSON.stringify({ _type: "mushroom" }));
  ...
  if (leg_x != null && leg_y != null) {
    ...
    let mushleg = selection
      .append("g")
      .attr("class", "bertinlegend")
      .attr("class", "legmushroom_" + options.id);

    // Leg top

    let legtop = mushleg.append("g");
    ...
    // leg bottom
    let legbottom = mushleg.append("g");
